...
export default function ReviewsSection() {
  ...
  const renderCard = (r: typeof reviews[number], i: number) => (
    <div
      key={`${r.id}-${i}`}
      className="group shrink-0 w-[300px] md:w-[360px] p-5 rounded-2xl bg-white dark:bg-[var(--color-surface)] dark:bg-cream-100 border border-cream-200 dark:border-cream-300/10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 cursor-default"
    >
