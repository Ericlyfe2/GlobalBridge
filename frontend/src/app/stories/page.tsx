    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {stories !== null && filtered.length === 0 && (
        ...
        <p className="text-xs text-ink-500 mt-8 text-center">
          Want to share yours? <Link href="/auth?mode=signup" className="text-clay-600 font-medium hover:underline">Sign up</Link> and submit a story from your profile — admin reviews before publishing.
        </p>
      </div>
