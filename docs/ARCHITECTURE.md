...
Also outstanding: push is wired but nothing calls dispatchNotification() yet for
deadlines or messages; a bottom navigation bar for mobile was specified but not
built; the 23MB hero video remains a mobile-performance problem in its own right.
