...
INSERT INTO users (id, email, password_hash, full_name, role, verification_status, country_of_origin, country_of_residence, bio, trust_score)
VALUES
  ('11111111-1111-1111-1111-111111111111', 'ama@globalbridge.app',     '$2b$10$pK5tW8T0js44bI.aeJin2.H8SNcEciQVW23kJwXdr2pUTxRyDQPPG', 'Ama Owusu',     'mentor',   'verified', 'Ghana',   'Canada',         '5 years in Toronto. Software engineer.', 92),
  ('22222222-2222-2222-2222-222222222222', 'kwame@globalbridge.app',   '$2b$10$pK5tW8T0js44bI.aeJin2.H8SNcEciQVW23kJwXdr2pUTxRyDQPPG', 'Kwame Adjei',   'mentor',   'verified', 'Ghana',   'United Kingdom', 'MSc Finance, Manchester.',                 85),
  ('33333333-3333-3333-3333-333333333333', 'yaa@globalbridge.app',     '$2b$10$pK5tW8T0js44bI.aeJin2.H8SNcEciQVW23kJwXdr2pUTxRyDQPPG', 'Yaa Boateng',   'mentor',   'verified', 'Ghana',   'Germany',        'PhD candidate, TU Berlin. DAAD scholar.',  88),
  ('44444444-4444-4444-4444-444444444444', 'admin@globalbridge.app',   '$2b$10$pK5tW8T0js44bI.aeJin2.H8SNcEciQVW23kJwXdr2pUTxRyDQPPG', 'Sarah Admin',   'admin',    'verified', NULL,      NULL,             'GlobalBridge platform admin.',             100),
  ('55555555-5555-5555-5555-555555555555', 'priya@globalbridge.app',   '$2b$10$pK5tW8T0js44bI.aeJin2.H8SNcEciQVW23kJwXdr2pUTxRyDQPPG', 'Priya Sharma',  'mentor',   'verified', 'India',   'United Kingdom', 'Data scientist at Revolut.',               80),
